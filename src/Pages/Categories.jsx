...
function Categories() {
  const Products = [
    ...
    },
    {
      ...
      price: "550",
      images: "/images/3.avif",
    },
    {
      id: 4,
      name: "boAt Lunar Discovery",
      price: "230",
      images: "/images/4.avif",
    },
    {
      id: 5,
      name: "boAt Rockerz 255 Pro+",
      price: "340",
      images: "/images/5.avif",
    },
    {
      id: 6,
      name: "boAt EnergyShroom PB300 Pro",
      price: "25000",
      images: "/images/7.avif",
    },
  ];

  return (
    <div className="container px-3 sm:px-0 mx-auto mb-16">
      <h1 className="text-3xl font-bold text-black mb-6 text-center sm:text-left">
        Categories
      </h1>
        ...
        {Products.map((product) => (
          ...
          >
            ...
            <div className="p-3 flex flex-col flex-1">
              <h2 className="text-sm sm:text-base font-semibold text-black line-clamp-1 mb-1">
                {product.name}
              </h2>
              <p className="text-green-700 font-bold sm:text-[14px]">
                {product.price} ৳
              </p>
            </div>
          </div>
